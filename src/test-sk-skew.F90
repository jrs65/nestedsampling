...
CONTAINS
  ...
  REAL(rk) FUNCTION like3(par)
    ...
    ! Return log likelihood.
    r1 = r + 0.2*(par(1) - hs)**2 + (par(2))**2
    r2 = r + 0.2*(par(1) + 0.5 * hs)**2 + (par(2) - (sqrt(3.0) * hs / 2.0))**2
    r3 = r + 0.2*(par(1) + 0.5 * hs)**2 + (par(2) + (sqrt(3.0) * hs / 2.0))**2
