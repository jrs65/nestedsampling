...
PROGRAM test_sk_3
  ...
  PRINT "(a,2f20.10)","Bias",(ev(1) / nl) - ev_analytic() - log(3.0),ev(2) / sqrt(1.0*nl**3)
  PRINT "(a,2f20.10)","Errors",sqrt((e2 / nl) - (ev(1) / nl)**2), ev(2) / nl

  PRINT "(a,f20.10)","S Bias",(epv / nl) - ev_analytic() - log(3.0)
  PRINT "(a,f20.10)","Error",sqrt((ep2 / nl) - (epv / nl)**2)
