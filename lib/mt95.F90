...
! Note by Richard Shaw. The author of the Fortran version Jose, has
! put this version under the same terms as the original C version, so
! for redistribution see:
